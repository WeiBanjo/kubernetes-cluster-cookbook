...
default['kubernetes_cluster']['master'].tap do |master|
...
default['kubernetes_cluster']['etcd'].tap do |etcd|
...
# Extra API args
default['kubernetes_cluster']['api']['args'] = []

# Tell kubelet not to schedule pods on master
default['kubernetes_cluster']['kubelet']['register']['schedulable'] = false
